(function () {
    ...
    angular
        .module('app.group')
        .controller('GroupHeaderController', GroupHeaderController);

    GroupHeaderController.$inject = ['$rootScope', '$state', '$mdSidenav'];

    /* @ngInject */
    function GroupHeaderController($rootScope, $state, $mdSidenav) {
        var vm = this;
