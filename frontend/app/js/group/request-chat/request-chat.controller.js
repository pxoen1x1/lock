(function () {
    ...
    angular
        .module('app.group')
        .controller('GroupRequestChatController', GroupRequestChatController);

    GroupRequestChatController.$inject = [
        '$scope',
        '$q',
        '$stateParams',
        '$mdSidenav',
    ...
    /* @ngInject */
    function GroupRequestChatController($scope, $q, $stateParams, $mdSidenav, coreConstants, coreDataservice,
