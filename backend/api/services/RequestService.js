...
let getRequestsRawQuery = `SELECT request.id,
                                  ...
                                  request.sp_auth_txn_id AS 'spAuthTxnId',
                                  ...
                                  request_serviceType.hintKey AS 'serviceType.hintKey',
                                  request_serviceType.required AS 'serviceType.required',
                                  ...
                                  owner.sp_customer_id AS 'owner.spCustomerId',
                                  ...
                                  executor.sp_merchant_id AS 'executor.spMerchantId',
                                  ...
                                  executor_details.car_license_plate_number AS 'executor.details.carLicensePlateNumber',
