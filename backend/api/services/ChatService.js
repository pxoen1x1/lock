...
let getChatsRawQuery = `SELECT chat.id,
                       ...
                       request_executor_details.is_bg_check_completed AS 'request.executor.details.isBGCheckCompleted',
...
let getChatMembersRawQuery = `SELECT member.id,
                             ...
                             member_details.is_bg_check_completed AS 'details.isBGCheckCompleted',
